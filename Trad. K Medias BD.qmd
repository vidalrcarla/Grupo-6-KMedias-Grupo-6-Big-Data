...
## 20.6 ¿Cuántos clústeres?

Al agrupar los datos de la base de datos `base_o` el número de clústeres que especificamos se puede basar en el conocimiento previo de los datos. Sin embargo, a menudo no tenemos este tipo de información a priori y la razón por la que estamos realizando análisis de conglomerados es para identificar qué conglomerados pueden existir. Entonces, ¿cómo hacemos para determinar el número correcto de k?
...
En este sentido, siguiendo con el ejemplo del perfil valórico de adultos chilenos, en ese caso en particular es posible
