...
subtitle: "Big Data para las Ciencias Sociales" 
date: last-modified
...
Con esta base y estas preguntas se espera identificar el perfil valórico de adultos que respondieron la encuesta. Para seleccionaremos solo las variables que vamos a utilizar y las adjuntaremos en una base de datos nueva, más reducida. Además se hará limpieza y preparación de datos para manipular la base.
